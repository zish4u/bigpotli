...
insert into categories (name, slug, description, image_url, meta_title, meta_description) values
  ('Abayas', 'abaya', 'Premium Abayas for every occasion', 'https://images.unsplash.com/photo-1594235412402-b1ed69967243?q=80&w=800', 'Buy Abayas Online in Bihar | Bigpotli', 'Shop premium Abayas online. Free delivery across Bihar – Patna, Gaya, Muzaffarpur & all districts. COD available.'),
  ('Hijabs', 'hijab', 'Elegant Hijabs in silk, chiffon & cotton', 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?q=80&w=800', 'Buy Hijabs Online in Bihar | Bigpotli', 'Shop premium Hijabs online. Free delivery across Bihar. COD available.'),
