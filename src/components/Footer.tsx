                    ...
                    {(siteConfig.social.instagram || siteConfig.social.facebook) && (
                        <div className="flex space-x-4">
                            {siteConfig.social.instagram && (
                                <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/5 rounded-full hover:bg-brand-gold transition-all text-white hover:scale-110">
                            ...
                            {siteConfig.social.facebook && (
                                <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/5 rounded-full hover:bg-brand-gold transition-all text-white hover:scale-110">
